       ...
       [:div {:class "container"} 
        ...
        [:nav {:class "top-nav"} 
         [:ul {:class "top-nav-social hidden-sm"} 
          ...
          [:li {} 
           [:a {:href "https://www.meetup.com/Cornwall-Digital/events/266342960/", :class "animated fadeIn animation-delay-9 meetup"}
            [:img {:src "/assets/img/meetup-logo.svg"}]]]] 
         [:div {:class "dropdown animated fadeInDown animation-delay-11"} 
          [:a {:href "/index.html"} 
           [:i {:class "fa fa-bullhorn"}] " Next Tech Jam: 14th Dec"]]]]]
